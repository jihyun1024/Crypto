...
이 리포지토리는 AES, DES, 그리고 타원 곡선 암호화 (ECC) 관련 알고리즘들이 구현되어 있습니다. 각 구현은 교육 목적으로 작성되었으며, 외부 라이브러리 없이 순수 C/C++로 구현되었습니다.
...
## 참고 사항
- 개인 학습 목적이므로, 실제 서비스에서는 OpenSSL, libsodium 등 검증된 라이브러리를 사용할 것을 권장합니다. 
- **참고 문서**: NIST FIPS 186-4, SECG SEC 1
